        ...
        if (paragraphs.length > 1) {
          ...
          placeholderLink.addEventListener("click", function (e) {
            ...
            if (secondParagraph.classList.contains("truncated")) {
              ...
              placeholderLink.innerText =
                clickHereForLess || "Click here for less"; // Change to "Click here for less"
            } else {
              secondParagraph.classList.add("truncated");
              placeholderLink.innerText =
                clickHereForMore || "Click here for more"; // Revert to "Click here for more"
            }
          });
        }
      }
